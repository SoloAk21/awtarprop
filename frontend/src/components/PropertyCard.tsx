import { MapPin, Bed, Bath, Maximize, Shield, Eye } from "lucide-react";
...
export function PropertyCard({
  ...
  return (
    <article className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-md transition-shadow">
      <div className="h-44 bg-slate-100 relative flex items-center justify-center text-slate-400">
        <span className="text-xs font-semibold px-3 py-1 bg-slate-200/80 rounded-full backdrop-blur-sm">
